    ...
    async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
        ...
        try {
            ...
            if (res.ok) {
                ...
                setError(data.error || t('signupFailed', { ns: 'common' }));
            }
        } catch (err) {
                ...
                <div className="bg-white/80 backdrop-blur-lg p-8 rounded-2xl shadow-2xl w-full max-w-md border border-white/20">
                    <div className="mb-8 text-center">
                        <h1 className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-2">
                            {t('signupTitle', { ns: 'admin' })}
                        </h1>
                        <p className="text-gray-600 text-sm">{t('eventPaymentSystem', { ns: 'admin' })}</p>
                    </div>
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div>
                            <label className="block text-gray-700 mb-2 font-medium text-sm" htmlFor="confirmPassword">
